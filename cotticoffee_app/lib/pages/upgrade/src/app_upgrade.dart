...
class AppUpgrade {
  ...
  static showUpgradeDialog(
    ...
    future.then((AppUpgradeInfo appUpgradeInfo) {
      if (appUpgradeInfo.isShowUpgrade) {
        showDialog(
            context: context,
              ...
              return WillPopScope(
                ...
                child: Dialog(
                    ...
                    child: AppUpgradePage(
                      ...
                      titleFontSize: appUpgradeInfo.titleFont,
                      bgColorWidgetWidth: appUpgradeInfo.bgColorWidgetWidth,
                      subTitle: appUpgradeInfo.subTitle,
                      contents: appUpgradeInfo.contents,
                      downloadUrl: appUpgradeInfo.apkDownloadUrl,
                      cancelButtonTitle: appUpgradeInfo.cancelButtonTitle,
                      okButtonTitle: appUpgradeInfo.okButtonTitle,
                      isForce: appUpgradeInfo.force,
                    )),
              );
            });
      }
