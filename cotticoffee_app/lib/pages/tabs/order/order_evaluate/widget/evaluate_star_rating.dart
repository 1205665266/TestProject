...
class RatingBar extends StatefulWidget {
  ...
  final IndexedWidgetBuilder? unselectedItemBuilder;
...
class _RatingBarState extends State<RatingBar> {
  ...
  Widget _buildRating(BuildContext context, int index) {
    ...
    final unselectedItem = widget.unselectedItemBuilder?.call(context, index);

    Widget _ratingWidget;

    if (index >= _rating) {
      _ratingWidget = unselectedItem ??
          _NoRatingWidget(
