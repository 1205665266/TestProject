  ...
  OverlayEntry _buildOverlay({
    ...
    if (direction == TooltipDirection.horizontal || direction == TooltipDirection.vertical) {
      ...
      final overlayRenderBox =
          Overlay.of(context, rootOverlay: false)!.context.findRenderObject() as RenderBox?;

      final targetGlobalCenter = targetRenderBox
          .localToGlobal(targetRenderBox.size.center(Offset.zero), ancestor: overlayRenderBox);
